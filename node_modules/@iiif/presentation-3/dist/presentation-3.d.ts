...
export interface AuthAccessService2_Common {
	id: string;
...
export type AccessTokenServiceRequest<S extends AuthAccessTokenService2, Origin extends string> = `${S["id"]}?origin=${Origin}&messageId=${string}` | `${S["id"]}?&messageId=${string}&origin=${Origin}`;
...
export type Search2AnnotationPage = Prettify<AnnotationPage & {
	...
	partOf: Prettify<AnnotationCollection & {
		total?: number;
		first: {
			id: string;
			type: "AnnotationPage";
...
export type Search2ContextualizingAnnotation = Prettify<Annotation & {
...
export type ChangeDiscoveryActor = {
	id: string;
...
export type ActivityCollectionProcessor = (collection: ActivityOrderedCollection, state: ChangeDiscoveryImplementationState) => ChangeDiscoveryImplementationState;
export type ActivityPageProcessor = (page: ActivityOrderedCollectionPage, state: ChangeDiscoveryImplementationState) => ChangeDiscoveryImplementationState;
